...
public class Controller implements Initializable { //Initializable and the method it adds are used when you want to interact with stuff
    // injected with @FXML. During construction those variables aren't filled so you cannot interact with them so JavaFX will call the
    // Initializable interface after everything is set up. At that point those variables are available and can be manipulated.
    ...
    public void check_collision_with_bricks() {
        all_bricks.removeIf(current_brick -> check_collision_with_single_brick(current_brick));  //removing that particular brick which
                                                                                                  // got collided with ball
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        timeline.setCycleCount(Animation.INDEFINITE);  //timeline will keep moving indefinitely until code exits
